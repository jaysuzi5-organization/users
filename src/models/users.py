"""
users Model and Pydantic Schema

This module defines:
- The SQLAlchemy ORM model for persisting users data.
- The Pydantic schema for validating API requests when creating a users.
...
class users(Base):
    """
    SQLAlchemy ORM model representing a users record.
    ...
    def __repr__(self):
        ...
        Example:
            <users(id=1, username='johndoe', email='john@example.com')>
        """
...
class usersCreate(BaseModel):
    """
    Pydantic schema for creating a new users.
